...
excerpt: |
  In this blog post, I’ll demonstrate how to set up a Workload Identity Federation between Keycloak and Google Cloud Platform, allowing a Keycloak client to impersonate a Google service account and create a Cloud Storage bucket.
type: post
blog: true
...
Create the `main.go` file add and below code to it and set the `googleProjectID` variable to your Google project ID.
